...
public class DateListActivity extends BaseActivity {
    ...
    private void setView() {
        new FireBaseModel(imei).readData("Date", new FireBaseModel.FireBaseCallBack() {
            @Override
    ...
    private void setRecyclerView(List<DirectionBean> list) {
    ...
    protected void setMenuItemAction(int itemID) {
        ...
        switch (itemID){
            case R.id.menu_add:
                new MyDialog(this).showDatePickerDialog(imei);
                break;
...
//                    new MyDialog(DateListActivity.this).deleteDialog(imei, key);
//                    return true;
//                }
//            });
        }
